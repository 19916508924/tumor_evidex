...
export const envConfigs: ConfigMap = {
  ...
  app_name: process.env.NEXT_PUBLIC_APP_NAME ?? 'Evidex',
  app_description:
    process.env.NEXT_PUBLIC_APP_DESCRIPTION ??
    'Traceable evidence intelligence for precision oncology.',
  app_logo: process.env.NEXT_PUBLIC_APP_LOGO ?? '/imgs/evidex/mark.svg',
  app_favicon: process.env.NEXT_PUBLIC_APP_FAVICON ?? '/imgs/evidex/mark.svg',
  app_preview_image:
    process.env.NEXT_PUBLIC_APP_PREVIEW_IMAGE ?? '/imgs/evidex/og-preview.png',
