...
export function PublicAppShell({
  ...
  return (
    <div className="evidex-product min-h-dvh min-w-[64rem] bg-[#F4F8FF] text-[#0B1F3A] selection:bg-[#B9D5FF] selection:text-[#07182D]">
      <a
        href="#main-content"
      ...
      <header className="sticky top-0 z-50 border-b border-[#BFD1E7]/80 bg-[#F4F8FF]/78 backdrop-blur-xl">
        <div className="mx-auto flex min-h-16 max-w-[90rem] items-center gap-5 px-8">
          <Link
            href={`/${locale}`}
          ...
          <nav
            aria-label="主要导航"
            className="ml-auto flex items-center gap-1 text-sm font-medium whitespace-nowrap"
          >
            <Link
              href={`/${locale}/ask`}
            ...
            <Link
              ...
              className="inline-flex min-h-10 items-center rounded-lg px-3 text-[#52637A] transition hover:bg-white/75 hover:text-[#0B3975] focus-visible:ring-2 focus-visible:ring-[#175CD3] focus-visible:outline-none"
            >
              治疗证据
            </Link>
            <Link
              href={`/${locale}/ops/reviews`}
              className="inline-flex min-h-10 items-center gap-2 rounded-lg bg-[#175CD3]/10 px-3 font-semibold text-[#0B3975] transition hover:bg-[#175CD3]/15 focus-visible:ring-2 focus-visible:ring-[#175CD3] focus-visible:outline-none"
            >
      ...
      <footer className="border-t border-[#C8D9EE] bg-white/45">
        <div className="mx-auto grid max-w-[90rem] grid-cols-[1fr_auto] items-end gap-5 px-8 py-8 text-sm text-[#52637A]">
          <div>
