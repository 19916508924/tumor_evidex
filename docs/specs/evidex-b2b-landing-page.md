...
- 当前只支持 1024px 以上桌面端，不提供折叠菜单或重复导航。
...
视觉：使用一条从“样本进入”到“报告交付”的横向时间线。滚动进入时三个节点依次激活，代价以短标签从节点下方出现。
...
- 只验收 1024px 至 1920px 桌面浏览器。
- 1024px 下仍保持单行导航、可读查询控件和完整主 CTA，不隐藏核心入口。
- 页面设置 1024px 最小宽度；更窄视口不属于当前产品范围。
...
| 层级       | 桌面端     | 字重       | 行高         |
| ---------- | ---------- | ---------- | ------------ |
| H1 中文    | 52 至 60px | 700        | 1.08 至 1.12 |
| H1 英文    | 56 至 64px | 700        | 1.02 至 1.08 |
| H2         | 38 至 46px | 650 至 700 | 1.12 至 1.2  |
| H3         | 22 至 28px | 650        | 1.25         |
| 首屏副标题 | 18 至 20px | 400 至 500 | 1.55 至 1.7  |
| 正文       | 16 至 18px | 400 至 500 | 1.6 至 1.75  |
| 标签与说明 | 12 至 14px | 550 至 650 | 1.4 至 1.55  |
